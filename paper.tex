...
$G$.  Let $\dist(\cdot, \cdot)$ be the natural metric on the Cayley graph of
$G$ with respect to $S$; on $G$ this metric agrees with the word metric. 
...
$G$ are $\delta$-thin. To ameliorate the growth of constants later on we in

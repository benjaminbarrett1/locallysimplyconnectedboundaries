...
\begin{proposition}\label{prop:continuouslimit}
  The map $i^m_\infty\from \Skel_2 K_m \to \boundary G$ is continuous.
\end{proposition}

\begin{proof}
  Fix $x \in \Skel_2 K_m$. Let $k$ be the constant given in the definition 
  of the map $i$. For $n\geq 0$ let $U_n$ be the star in $\beta^{nk} 
  \Skel_2K_m$ of the minimal simplex of $\beta^{nk}\Skel_2K_m$ 
  containing $x$. Then $U_n$ is a neighbourhood of $x$ for each $n$. 

  For each $n$, the restriction of $i^m_{m+n}$ to a simplex in 
  $\beta^{nk}\Skel_2K_m$ is affine, and therefore has image contained in a 
  simplex of $\Skel_2 K_{m+n}$. The point $x$ is contained in every simplex 
...
\begin{proof}
  To start with, apply Proposition \todo{extending affine maps} with $k = C +

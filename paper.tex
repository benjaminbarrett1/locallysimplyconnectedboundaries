...
Given points $x$ and $y$ in $G \union \boundary G$ we will often denote by
$[x,y]$ a geodesic from $x$ to $y$, thought of as a subset of the Cayley graph
together with its boundary. Geodesics in hyperbolic spaces are not necessarily
unique, so this notation will stand for a choice of geodesic, but the choice
will not matter.
